...
import com.springboot.myproject.config.auth.dto.OAuthAttributes;
import com.springboot.myproject.config.auth.dto.SessionUser;
import com.springboot.myproject.domain.user.User;
import com.springboot.myproject.domain.user.UserRepository;
